    ...
    *,
    ...
    if metadata_selected:
        ...
        metadata_key = _component_key({
            ...
            'plannedEpisodes': [t.get('episode') for t in config.get('hubTask', {}).get('moviePlan', {}).get('targets', [])],
    ...
    if route.get("status") == "OK" and needs_library:
        ...
        library_key = _component_key({
            ...
            "title": lookup_title,
            "preferred": preferred,
            "manualTarget": config.get("hubTask", {}).get("libraryTarget"),
            "deliveryMode": config.get("hubTask", {}).get("deliveryMode"),
